This is the README, read this me
...
To run the frontend, make sure your terminal is in the frontend folder. Then use the command
```
npm run dev
```
And the terminal will provide a link through your local machine.



accounts sub(site)app
